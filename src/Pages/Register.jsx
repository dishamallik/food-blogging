...
import logo from '../assets/Mobile login-bro.png'
    ...
    return (
        ...
        <div className="max-w-96">
               ...
               <div className="text-left">
                    <h1 className="text-5xl text-green-700  font-bold mb-5">Register Now!</h1>
                </div>
                <div className="card shrink-0 lg:w-96 max-w-sm shadow-2xl bg-green-50">
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        ...
                        <div className="form-control mt-6">
                            <button className="btn btn-outline bg-green-600">Register</button>
                        </div>
